...
This is a handler written in bash to push metrics that sensu collects into influxdb V0.9 DB. I was unable to use the current handlers or get them to work. So I decided to write my own our of frustration.
